...
public class NotificationUtil {
    public static final String EXTRA_MESSAGE = "com.example.android.preview.support.wearable.notifications.MESSAGE";
    public static final String EXTRA_REPLY = "com.example.android.preview.support.wearable.notifications.REPLY";
    ...
    public static PendingIntent getExamplePendingIntent(Context context, int messageResId) {
        ...
        return PendingIntent.getBroadcast(context, messageResId /* requestCode */, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    }
}
